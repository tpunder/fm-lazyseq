 ...
 */
final class SortedLazySeq[V, K](reader: LazySeq[V], key: V => K, unique: Boolean = false, bufferSizeLimitMB: Int = SortedLazySeqBuilder.DefaultBufferSizeLimitMB, bufferRecordLimit: Int = SortedLazySeqBuilder.DefaultBufferRecordLimit)(implicit serializer: Serializer[V], ord: Ordering[K]) extends LazySeq[V] {  
